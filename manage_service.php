...
<div class="container-fluid">
    <form action="" id="service-form">
        ...
        <div class="form-group">
            ...
            <input type="text" step="any" name="fee" id="fee" class="form-control form-control-border text-right" placeholder="Enter Fee" value ="<?php echo isset($fee) ? $fee : 0 ?>" required>
        </div>
    </form>
</div>
<script>
