        ...
        <div class="container-fluid">
			<table class="table table-hover ">
				...
				<tbody>
					<?php 
						$i = 1;
						$qry = $conn->query("SELECT * from `archive` order by unix_timestamp(`date_created`) desc ");
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="./?page=archive/viewarchive_details&id=<?php echo $row['id'] ?>" data-id=""><span class="fa fa-window-restore text-gray"></span>Restore</a>
