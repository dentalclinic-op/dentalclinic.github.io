                ...
                <div id="outprint">
                    <fieldset>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        <legend class="text-muted border-bottom">Customer Information</legend>
                                ...
                                <br/>
                                    <fieldset>
                                        <legend class="text-muted border-bottom"></legend>
                                        <table class="table table-stripped table-bordered" data-placeholder='true'>
                                            ...
                                            <tbody>
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Customer Type</th>
